...
The Face Mesh Module (`face_mesh.py`) is the system's "face detector and mapper" - it looks at images from the camera and finds human faces. Once it finds a face, it maps out 478 specific points on that face, like a digital connect-the-dots that marks important features such as the eyes, nose, mouth, eyebrows, and even the iris of each eye.
